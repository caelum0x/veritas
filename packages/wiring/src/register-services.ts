// Register all application-service singletons using resolved repository dependencies.
...
/** Private mirror of the RegistrationMeta shape used by the store. */
...
/** In-memory RegistrationMetaStore for default (non-persistent) deployments. */
