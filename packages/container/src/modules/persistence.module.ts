// Persistence module: registers all in-memory repository implementations.
...
/** Register all repository singletons onto the container. */
export function registerPersistence(c: Container): void {
